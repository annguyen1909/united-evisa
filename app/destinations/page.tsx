...
export const metadata: Metadata = {
    title: 'Destinations | eVisa Requirements by Country | United eVisa',
    ...
    alternates: {
        canonical: 'https://unitedevisa.com/destinations',
    },
}
...
export default function DestinationsPage() {
    return (
        <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <div className="relative h-[70vh] min-h-[500px] flex items-center justify-center text-white overflow-hidden bg-blue-950">
                ...
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        priority
                    />
                    <div className="absolute inset-0 bg-gradient-to-b from-blue-950/80 via-blue-950/40 to-slate-50"></div>
                </div>
                ...
                <div className="container mx-auto px-4 relative z-10 text-center space-y-8 pb-16">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[1.1] animate-fade-in-up">
                        Global Travel <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-amber-300">Simplified.</span>
                    </h1>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-16 text-center">
                        <div className="space-y-4">
                            <div className="text-5xl font-black text-blue-400 tracking-tighter">5,000+</div>
                        ...
                        <div className="space-y-4">
                            <div className="text-5xl font-black text-blue-400 tracking-tighter">24/7</div>
                        ...
                        <div className="space-y-4">
                            <div className="text-5xl font-black text-blue-400 tracking-tighter">Instant</div>
