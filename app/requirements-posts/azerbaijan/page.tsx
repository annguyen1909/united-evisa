...
const azerbaijanVisaTypes = [
  {
    ...
    features: ['Cultural tourism', 'Historical sites', 'City exploration', 'Caspian Sea visits']
  },
  {
  ...
  },
  {
    ...
    govFee: 50,
    processingTime: '3 working days',
    features: ['Medical treatment', 'Healthcare visits', 'Medical tourism', 'Health consultations']
  }
];
...
const faqs = [
  {
    ...
    answer: "Most foreign nationals require a visa to enter Azerbaijan. However, citizens of certain countries may be exempt from visa requirements. The Azerbaijan eVisa system allows travelers from eligible countries to apply online before their trip. The eVisa is mandatory for tourism, business, and treatment purposes."
  },
  {
    question: "How long does it take to process an Azerbaijan eVisa?",
    answer: "Processing time for Azerbaijan eVisas ranges from 3-5 working days. We recommend applying at least 1 week before your intended travel date to avoid any delays. Our platform has an 90% approval rate, and we provide 24/7 support throughout the application process."
  },
  {
    question: "What documents do I need for an Azerbaijan eVisa?",
    answer: "You'll need a valid passport with at least 6 months validity beyond your intended stay, a recent passport-size photo, proof of accommodation in Azerbaijan, return flight tickets, and sufficient funds for your stay. Business travelers may need additional documents like invitation letters. All documents should be clear, legible, and in English."
  },
  {
    question: "Can I extend my Azerbaijan visa?",
    answer: "Yes, you can extend your Azerbaijan visa while in the country. You'll need to visit the State Migration Service in Baku or other major cities. Extensions are typically granted for valid reasons such as medical treatment, business needs, or tourism. There are fees associated with visa extensions, and the process can take several days."
  },
  {
    question: "Is it safe to travel to Azerbaijan?",
    answer: "Azerbaijan is generally safe for tourists, especially in popular tourist areas like Baku, Ganja, and the Absheron Peninsula. However, it's important to stay informed about current travel advisories, avoid certain areas near the border with Armenia, and take standard safety precautions like not walking alone at night. Most tourist destinations have good security measures in place."
  },
  {
    question: "What is the best time to visit Azerbaijan?",
    answer: "The best time to visit Azerbaijan depends on what you want to see. Spring (March-May) and autumn (September-November) offer pleasant weather for exploring cities and cultural sites. Summer (June-August) can be hot but is good for mountain regions. Winter (December-February) is ideal for skiing in the Caucasus Mountains."
  },
  {
    question: "How much does an Azerbaijan eVisa cost?",
    answer: "Azerbaijan eVisa fees are set by the government: Tourist, Business, and Treatment eVisas all cost $50 for 30-day stays. We do not charge additional urgent processing fees, ensuring transparent pricing. Payment can be made securely online using credit cards or bank transfers."
  },
  {
    question: "Can I apply for an Azerbaijan eVisa if I have a criminal record?",
    answer: "Individuals with criminal records may face additional scrutiny during the Azerbaijan eVisa application process. It's important to be honest about your background and provide any required documentation. Some convictions may result in visa denial, while others may require additional processing time."
  },
  {
    question: "What happens if my Azerbaijan eVisa application is denied?",
    answer: "If your Azerbaijan eVisa application is denied, you will receive a notification explaining the reason. Common reasons include incomplete documentation, insufficient funds, or security concerns. You can reapply after addressing the issues, or contact our support team for guidance on improving your application."
  },
  {
    question: "Can I enter Azerbaijan multiple times with one eVisa?",
    answer: "Azerbaijan eVisas are typically single-entry visas. If you plan to leave and re-enter Azerbaijan during your trip, you'll need to apply for a new eVisa each time. For multiple entries, consider applying for a different visa type or planning your itinerary to avoid multiple border crossings."
  },
  {
    question: "What should I do if I lose my Azerbaijan eVisa approval letter?",
    answer: "If you lose your Azerbaijan eVisa approval letter, you can download it again from our platform or contact our support team. It's recommended to carry both digital and printed copies of your eVisa approval when traveling. The approval letter is required for entry into Azerbaijan."
  }
];

export default function AzerbaijanRequirementsPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-amber-700 text-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="/images/country/azerbaijan/azerbaijan-bg.jpg"
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              Azerbaijan Visa <span className="text-blue-200">Requirements</span>
            </h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Complete guide to Azerbaijan eVisa requirements, application process, and travel information for your Caucasus adventure
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <CheckEligibilityWithPreset 
            presetDestination="az"
            title="Check Your Azerbaijan Visa Eligibility"
            description="Select your nationality to check if you need a visa for Azerbaijan"
          />
        </div>
        ...
        <section id="overview" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">About Azerbaijan</h3>
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-600 leading-relaxed mb-4">
                    Azerbaijan, located at the crossroads of Eastern Europe and Western Asia, is a country rich in history, 
                    culture, and natural resources. From the modern skyline of Baku to the ancient mud volcanoes and the 
                    Caspian Sea coastline, Azerbaijan offers a unique blend of old and new.
                  </p>
                  <p className="text-slate-600 leading-relaxed mb-4">
                    The country is home to the Caucasus Mountains, the Absheron Peninsula, and the world's largest 
                    collection of mud volcanoes. Baku, the capital city, serves as a major hub for business and tourism 
                    in the Caucasus region.
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    Azerbaijan's visa system has been modernized with the introduction of the eVisa program in 2017, 
                    making it easier for international travelers to obtain their travel authorization online before arrival.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2">
                  <span className="text-sm font-semibold text-slate-800">🇦🇿 Azerbaijan</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-r from-blue-50 to-amber-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="text-slate-600">Baku</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="text-slate-600">Azerbaijani</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100">
                ...
                <p className="text-slate-600">Azerbaijani Manat (AZN)</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="visa-types" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {azerbaijanVisaTypes.map((visa, index) => (
                <Card key={index} className="overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-white/90 backdrop-blur-sm">
                  ...
                  <CardFooter className="pt-4 pb-6">
                    <Link href={`/apply?country=azerbaijan&type=${encodeURIComponent(visa.id)}`} className="w-full">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    'Proof of accommodation in Azerbaijan (hotel bookings or invitation letter)',
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    'Invitation letter from Azerbaijani business partner or organization',
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { type: 'Tourist Evisa', fee: '$50', duration: '30 days' },
                    { type: 'Business Evisa', fee: '$50', duration: '30 days' },
                    { type: 'Treatment Evisa', fee: '$50', duration: '30 days' }
                  ].map((visa, index) => (
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-slate-600">3-5 working days</p>
                  </div>
        ...
        <section id="why-choose-us" className="mb-16">
          <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-2xl border border-blue-200 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">
              Why Choose United eVisa Services for Your Azerbaijan Visa?
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="text-center p-6 bg-white rounded-xl shadow-md">
                ...
                <h3 className="font-semibold text-slate-800 mb-2">90% Approval Rate</h3>
              ...
              <div className="text-center p-6 bg-white rounded-xl shadow-md">
                ...
                <p className="text-sm text-slate-600">Bank-level security with 3-5 day processing for most applications.</p>
              </div>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-800 mb-4 text-center">Get Your Azerbaijan eVisa Today</h3>
              <p className="text-slate-600 text-center mb-6">
                Join thousands of satisfied travelers who have successfully obtained their Azerbaijan visa through our platform. 
                Our streamlined process ensures you get your visa quickly and hassle-free.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/apply?country=azerbaijan">
        ...
        {/* Comprehensive Azerbaijan Travel Guide */}
        <section id="travel-guide" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              <Globe className="h-8 w-8 text-blue-600" />
              Complete Azerbaijan Travel Guide & Visa Information
            </h2>
            
            <div className="prose prose-slate max-w-none">
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">About Azerbaijan eVisa Requirements</h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Azerbaijan's eVisa system was introduced to streamline the visa application process for international travelers. 
                The Azerbaijan eVisa is an electronic travel authorization that allows visitors to enter Azerbaijan for tourism, 
                business, and other purposes. This digital system has significantly improved the overall travel experience for 
                millions of visitors to Azerbaijan each year.
              </p>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Azerbaijan eVisa Eligibility & Requirements</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Most foreign nationals require an Azerbaijan eVisa to enter the territory, with the exception of citizens from some 
                visa-waiver countries. The eVisa system is available to travelers from eligible countries worldwide, making Azerbaijan 
                one of the most accessible destinations for international visitors interested in Caspian culture, historical sites, 
                and Caucasus heritage.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who Needs an Azerbaijan eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li> International tourists visiting Azerbaijan for leisure</li>
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who is Exempt from Azerbaijan eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li> Azerbaijani citizens and permanent residents</li>
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Azerbaijan eVisa Application Process Explained</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                The Azerbaijan eVisa application process is designed to be simple and user-friendly. Our platform guides you 
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Azerbaijan Visa Processing Times & Fees</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Azerbaijan eVisa processing times typically take 4 working days for normal processing. The government fees 
                are transparent: Tourist eVisa costs $25, while Business eVisa costs $35. We provide transparent pricing 
                with no hidden fees.
              </p>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Popular Destinations in Azerbaijan</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Azerbaijan offers diverse attractions for every type of traveler. From the modern capital of Baku 
                to the ancient historical sites, from the Caspian Sea coast to the Caucasus mountains, Azerbaijan provides 
                unforgettable experiences. The country's unique blend of modern development, historical heritage, 
                and Caspian culture creates a fascinating destination for travelers.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Modern Baku</h4>
                  <p className="text-sm text-slate-600">
                    From the Flame Towers to the Heydar Aliyev Center, from modern architecture to contemporary culture, 
                    Azerbaijan offers world-class urban experiences and modern attractions.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Historical Sites</h4>
                  <p className="text-sm text-slate-600">
                    From the Old City of Baku to ancient fortresses, from historical monuments to cultural sites, 
                    Azerbaijan offers rich historical experiences and cultural heritage.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-800 mb-2">Natural Landscapes</h4>
                  <p className="text-sm text-slate-600">
                    From the Caspian Sea to the Caucasus Mountains, from national parks to scenic landscapes, Azerbaijan offers 
                    stunning natural environments and outdoor adventures.
                  </p>
                </div>
              </div>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Azerbaijan Travel Tips & Best Practices</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                When planning your trip to Azerbaijan, consider the continental climate and seasonal attractions. The best 
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose United eVisa Services for Azerbaijan Visa Applications</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                United eVisa Services has been helping travelers obtain their Azerbaijan visas since the eVisa system 
                was introduced. Our expertise in the Azerbaijan visa process, combined with our 98% approval rate and 24/7 
        ...
        <section id="analytics" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              ...
              Azerbaijan Visa Processing Insights & Travel Analytics
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-blue-600">3.2 days</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-blue-600">3.0 days</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-blue-600">2.9 days</span>
                    </div>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> Azerbaijan State Migration Service & United eVisa Services processing data
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> <a href="https://azerbaijan-immigration.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-900">azerbaijan-immigration.com</a> (2024)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-slate-800 mb-4">Best Time to Visit Azerbaijan</h3>
                ...
                <div className="mt-4 p-3 bg-purple-100 rounded-lg">
                  <p className="text-xs text-purple-800">
                    <strong>Source:</strong> Azerbaijan Meteorological Department & Tourism Board
                  </p>
                </div>
              </div>
            </div>
