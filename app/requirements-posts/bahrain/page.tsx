...
const bahrainVisaTypes = [
  {
    ...
    features: ['Tourism', 'Family visits', 'Short stays']
  },
  {
    ...
    govFee: 73,
    processingTime: '3 working days',
    features: ['Tourism', 'Frequent visits', 'Family visits']
  },
  {
    ...
    govFee: 147,
    processingTime: '3 working days',
    features: ['Long-term tourism', 'Frequent visits', 'Family visits']
  },
  {
    ...
    govFee: 54,
    processingTime: '3 working days',
    features: ['Business meetings', 'Conferences', 'Short business trips']
  },
  {
    ...
    govFee: 73,
    processingTime: '3 working days',
    features: ['Business', 'Frequent business trips', 'Meetings']
  },
  {
    ...
    govFee: 147,
    processingTime: '3 working days',
    features: ['Long-term business', 'Frequent business trips', 'Meetings']
  },
];

const faqs = [
  {
    question: 'Do I need a visa to visit Bahrain?',
    answer: 'Most foreign nationals require a visa to enter Bahrain. The eVisa system allows travelers from eligible countries to apply online before their trip. Check your eligibility on our platform.'
  },
  {
    question: 'How long does it take to process a Bahrain eVisa?',
    answer: 'Processing time for Bahrain eVisas is typically 1-3 working days. Apply at least 1 week before your travel date to avoid delays.'
  },
  {
    question: 'What documents do I need for a Bahrain eVisa?',
    answer: 'You will need a valid passport (at least 6 months validity), a recent passport-size photo, proof of accommodation, return flight tickets, and sufficient funds. Business travelers may need an invitation letter.'
  },
  {
    question: 'Can I extend my Bahrain visa?',
    answer: 'Visa extensions are possible in Bahrain for valid reasons. Visit the Nationality, Passports & Residence Affairs (NPRA) office for more information.'
  },
  {
    question: 'Is Bahrain safe for tourists?',
    answer: 'Bahrain is generally safe for tourists. Exercise standard precautions and stay updated on travel advisories.'
  },
  {
    question: 'How much does a Bahrain eVisa cost?',
    answer: 'Government fees range from $54 to $147 depending on visa type and duration. See the visa types section for details.'
  },
  {
    question: 'Can I apply for a Bahrain eVisa if I have a criminal record?',
    answer: 'Applicants with criminal records may face additional scrutiny. Be honest in your application and provide all required documents.'
  },
  {
    question: 'What happens if my Bahrain eVisa application is denied?',
  ...
  {
    question: 'Can I enter Bahrain multiple times with one eVisa?',
    answer: 'Some Bahrain eVisas allow multiple entries. Check the visa type details for entry conditions.'
  },
  {
    question: 'What should I do if I lose my Bahrain eVisa approval letter?',
...
const breadcrumbItems = [
  ...
  { label: "Bahrain Requirements" }
];

export default function BahrainRequirementsPage() {
  ...
  return (
    <>
      <RequirementsPostStructuredData country="Bahrain" countrySlug="bahrain" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-amber-700 text-white overflow-hidden">
          ...
          <div className="absolute inset-0">
            <Image
              src="/images/country/bahrain/bahrain-bg.jpg"
              alt="Bahrain eVisa requirements - beautiful Middle Eastern destinations and landmarks for visa travelers"
              fill
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <CheckEligibilityWithPreset 
            presetDestination="bh"
            title="Check Your Bahrain Visa Eligibility"
            description="Select your nationality to check if you need a visa for Bahrain"
          />
        </div>
        ...
        <section id="overview" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">About Bahrain</h3>
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-600 leading-relaxed mb-4">
                    Bahrain, an island nation in the Persian Gulf, is known for its rich history, modern skyline, and vibrant culture. From ancient forts to luxury shopping and beautiful beaches, Bahrain offers a unique blend of tradition and modernity for travelers.
                  </p>
                  <p className="text-slate-600 leading-relaxed mb-4">
                    The capital, Manama, is a cosmopolitan city with world-class dining, shopping, and entertainment. Bahrain is also famous for its Formula 1 Grand Prix, pearl diving heritage, and warm hospitality.
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    The Bahrain eVisa system makes it easy for international visitors to obtain travel authorization online before arrival, streamlining the process for tourism and business travel.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2">
                  <span className="text-sm font-semibold text-slate-800">🇧🇭 Bahrain</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-r from-blue-50 to-amber-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="text-slate-600">Manama</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100">
                ...
                <p className="text-slate-600">Bahraini Dinar (BHD)</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="visa-types" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {bahrainVisaTypes.map((visa, index) => (
                <Card key={index} className="overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-white/90 backdrop-blur-sm">
                  ...
                  <CardFooter className="pt-4 pb-6">
                    <Link href={`/apply?country=bahrain&type=${encodeURIComponent(visa.id)}`} className="w-full">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    'Proof of accommodation in Bahrain (hotel bookings or invitation letter)',
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    'Invitation letter from Bahraini business partner or organization',
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-amber-50 rounded-lg border border-blue-100">
                    ...
                    <p className="text-sm text-slate-600">Pleasant weather, ideal for sightseeing and outdoor activities</p>
                  </div>
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                    <h4 className="font-semibold text-slate-800 mb-2">April to October</h4>
                    <p className="text-sm text-slate-600">Hotter months, suitable for beach and water activities</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    'King Fahd Causeway (road link to Saudi Arabia)',
                    'Sea ports (Khalifa Bin Salman Port)'
                  ].map((entry, index) => (
        ...
        <section id="why-choose-us" className="mb-16">
          <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-2xl border border-blue-200 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">
              Why Choose United eVisa Services for Your Bahrain Visa?
            </h2>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-800 mb-4 text-center">Get Your Bahrain eVisa Today</h3>
              <p className="text-slate-600 text-center mb-6">
                Join thousands of satisfied travelers who have successfully obtained their Bahrain visa through our platform. 
                Our streamlined process ensures you get your visa quickly and hassle-free.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/apply?country=bahrain">
        ...
        {/* Comprehensive Bahrain Travel Guide */}
        <section id="travel-guide" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              <Globe className="h-8 w-8 text-blue-600" />
              Complete Bahrain Travel Guide & Visa Information
            </h2>
            
            <div className="prose prose-slate max-w-none">
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">About Bahrain eVisa Requirements</h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Bahrain's eVisa system streamlines the visa application process for international travelers. The Bahrain eVisa is an electronic travel authorization for tourism or business, making travel to Bahrain more accessible and efficient.
              </p>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Bahrain eVisa Eligibility & Requirements</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Most foreign nationals require a Bahrain eVisa to enter the country. The eVisa system is available to travelers from over 100 countries, making Bahrain a welcoming destination for global visitors.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who Needs a Bahrain eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li> International tourists visiting Bahrain for leisure</li>
                    <li> Business travelers attending meetings or conferences</li>
                    <li> Family visitors</li>
                  </ul>
                </div>
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who is Exempt from Bahrain eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li> GCC citizens (Gulf Cooperation Council)</li>
                    <li> Diplomatic passport holders</li>
                    <li> Crew members on duty</li>
                  </ul>
                </div>
              </div>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Bahrain eVisa Application Process Explained</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                The Bahrain eVisa application process is simple and user-friendly. Our platform guides you through each step, ensuring your application meets all requirements for approval. The process is fully online, eliminating the need to visit embassies or consulates.
              </p>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Bahrain Visa Processing Times & Fees</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Bahrain eVisa processing times are typically 1-3 working days. Government fees range from $54 to $147 depending on visa type and duration. We do not charge additional urgent processing fees, ensuring transparent pricing.
              </p>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Popular Destinations in Bahrain</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Bahrain offers a variety of attractions, from the Bahrain Fort (Qal'at al-Bahrain) and Bahrain National Museum to the vibrant Manama Souq and beautiful Amwaj Islands. The country is also known for its Formula 1 Grand Prix and pearl diving heritage.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">History & Culture</h4>
                  <p className="text-sm text-slate-600">
                    Explore ancient forts, museums, and traditional markets that showcase Bahrain's rich heritage.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Modern Attractions</h4>
                  <p className="text-sm text-slate-600">
                    Enjoy luxury shopping, fine dining, and world-class entertainment in Manama.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-800 mb-2">Beaches & Islands</h4>
                  <p className="text-sm text-slate-600">
                    Relax on Bahrain's beautiful beaches and visit the Amwaj Islands for water sports and leisure.
                  </p>
                </div>
              </div>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Bahrain Travel Tips & Best Practices</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                When planning your trip to Bahrain, consider the weather patterns and local customs. The best time to visit is from November to March for pleasant weather. Always carry your eVisa approval letter, passport, and other required documents. Travel insurance is recommended.
              </p>
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose United eVisa Services for Bahrain Visa Applications</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                United eVisa Services has helped thousands of travelers obtain their Bahrain visas. Our expertise, 85% approval rate, and 24/7 customer support make us the preferred choice. We provide transparent pricing and fast processing for your convenience.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="analytics" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              ...
              Bahrain Visa Processing Insights & Travel Analytics
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-blue-600">2.2 days</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> Bahrain NPRA & United eVisa Services processing data
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Tourist eVisa (Single Entry, 14 days)</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Tourist eVisa (Multiple, 3 months)</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Tourist eVisa (Multiple, 1 year)</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Business eVisa (Single Entry, 14 days)</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Business eVisa (Multiple, 3 months)</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Business eVisa (Multiple, 1 year)</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                        <div className="h-full bg-blue-500 rounded-full" style={{width: '7%'}}></div>
                      </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Best Time to Visit Bahrain</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-xs text-slate-600">Cool & Pleasant</p>
                  <div className="mt-2">
                ...
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-xs text-slate-600">Hot & Dry</p>
                  <div className="mt-2">
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
              ...
              <div className="mt-4 p-3 bg-purple-100 rounded-lg">
                <p className="text-xs text-purple-800">
                  <strong>Source:</strong> Bahrain Meteorological Directorate & Tourism Board
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-8 p-6 bg-slate-50 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-600">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-blue-600" />
                    <span>85% approval rate with our expert review</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-blue-600" />
