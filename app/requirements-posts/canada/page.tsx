...
export default function CanadaRequirementsPage() {
  ...
  return (
    <>
      <RequirementsPostStructuredData country="Canada" countrySlug="canada" />
        ...
        <div className="relative bg-gradient-to-r from-red-600 via-red-700 to-red-800 text-white overflow-hidden">
          ...
          <div className="absolute inset-0">
            <Image
              ...
              alt="Canada eVisa requirements - beautiful North American destinations and landmarks for visa travelers"
              fill
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-16">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                Canada eVisa Requirements & Application Guide
              </h1>
              <p className="text-xl text-red-100 max-w-3xl mx-auto leading-relaxed">
                Complete guide to Canada eVisa requirements, application process, and travel information for your North American adventure
              </p>
            </div>
          </div>
        </div>
