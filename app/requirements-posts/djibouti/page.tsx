...
export default function DjiboutiRequirementsPage() {
  ...
  return (
    <>
      <RequirementsPostStructuredData country="Djibouti" countrySlug="djibouti" />
        ...
        <div className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-amber-700 text-white overflow-hidden">
          ...
          <div className="absolute inset-0">
            <Image
              ...
              alt="Djibouti eVisa requirements - beautiful East African destinations and landmarks for visa travelers"
              fill
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-16">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                Djibouti eVisa Requirements & Application Guide
              </h1>
              <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
                Complete guide to Djibouti eVisa requirements, application process, and travel information for your East African adventure
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <CheckEligibilityWithPreset 
            presetDestination="dj"
            title="Check Your Djibouti Visa Eligibility"
            description="Select your nationality to check if you need a visa for Djibouti"
          />
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2">
                  <span className="text-sm font-semibold text-slate-800">🇩🇯 Djibouti</span>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    ...
                    <ul className="text-sm text-slate-600 space-y-1">
                      <li>• Djibouti has a hot and arid climate</li>
                      <li>• French and Arabic are official languages</li>
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who Needs a Djibouti eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose United eVisa Services for Djibouti Visa Applications</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                United eVisa Services has been helping travelers obtain their Djibouti visas since the eVisa system 
              ...
              <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> Djibouti Ministry of Foreign Affairs & United eVisa Services processing data
                  </p>
                </div>
              </div>
