...
export const metadata: Metadata = {
  title: "Gabon Visa Requirements & eVisa Application | Worldmaxxing Global Services",
  ...
  openGraph: {
    ...
    url: "https://visa.worldmaxxing.com/requirements-posts/gabon",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Gabon Visa Requirements - Worldmaxxing Global Services",
      }
    ],
    locale: "en_US",
    type: "article",
  ...
  alternates: {
    canonical: "https://visa.worldmaxxing.com/requirements-posts/gabon",
  },
  robots: {
    index: true,
    follow: true,
