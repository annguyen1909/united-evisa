...
export const metadata: Metadata = {
  title: "India Visa Requirements & eVisa Application | Worldmaxxing Global Services",
  ...
  openGraph: {
    ...
    url: "https://visa.worldmaxxing.com/requirements-posts/india",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "India Visa Requirements - Worldmaxxing Global Services",
      }
    ],
    locale: "en_US",
    type: "article",
  ...
  alternates: {
    canonical: "https://visa.worldmaxxing.com/requirements-posts/india",
  },
  robots: {
    index: true,
    follow: true,
