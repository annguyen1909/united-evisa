...
export default function IndiaRequirementsPage() {
  ...
  return (
    <>
      <RequirementsPostStructuredData country="India" countrySlug="india" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        {/* Hero Section */}
        <div className="relative bg-gradient-to-r from-orange-600 via-white to-green-600 text-white overflow-hidden">
          <div className="absolute inset-0 bg-black/20"></div>
          <div className="absolute inset-0">
            <Image
              src="/images/country/india/india-bg.jpg"
              alt="India eVisa requirements - beautiful South Asian destinations and landmarks for visa travelers"
              fill
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-16">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                India eVisa Requirements & Application Guide
              </h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <CheckEligibilityWithPreset 
            presetDestination="in"
            title="Check Your India Visa Eligibility"
            description="Select your nationality to check if you need a visa for India"
          />
        </div>
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who Needs an India eVisa?</h4>
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose United eVisa Services for India Visa Applications</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                United eVisa Services has been helping travelers obtain their India visas since the eVisa system 
