...
const indonesiaVisaTypes = [
  {
    ...
    features: ['Beach vacations', 'Cultural exploration', 'Island hopping', 'Temple visits']
  },
  {
    ...
    govFee: 126,
    processingTime: '2 working days',
    features: ['Extended travel', 'Multiple destinations', 'Deep cultural immersion', 'Adventure tourism']
  }
];
...
const faqs = [
  {
    ...
    answer: "Most foreign nationals require a visa to enter Indonesia. The Indonesia eVisa system allows travelers from eligible countries to apply online before their trip. The eVisa is mandatory for tourism and other purposes. Citizens of some countries may be exempt from visa requirements for short stays."
  },
  {
    question: "How long does it take to process an Indonesia eVisa?",
    answer: "Processing time for Indonesia eVisas typically takes 2 working days for normal processing, with a super urgent option available in 2 hours. We recommend applying at least 1 week before your intended travel date to avoid any delays. Our platform has a 98% approval rate, and we provide 24/7 support throughout the application process."
  },
  {
    question: "What documents do I need for an Indonesia eVisa?",
    answer: "You'll need a valid passport with at least 6 months validity beyond your intended stay, a recent passport-size photo, proof of accommodation in Indonesia, return flight tickets, and sufficient funds for your stay. All documents should be clear, legible, and in English."
  },
  {
    question: "Can I extend my Indonesia visa?",
    answer: "Yes, you can extend your Indonesia visa while in the territory. You'll need to visit the Immigration Office in Indonesia. Extensions are typically granted for valid reasons such as tourism, business needs, or medical treatment. There are fees associated with visa extensions, and the process can take several days."
  },
  {
    question: "Is it safe to travel to Indonesia?",
    answer: "Indonesia is generally a safe destination for tourists. The country has friendly locals, well-maintained infrastructure in tourist areas, and a rich cultural heritage. However, it's important to stay informed about current travel advisories and take standard safety precautions, especially when traveling to remote areas."
  },
  {
    question: "What is the best time to visit Indonesia?",
    answer: "The best time to visit Indonesia is during the dry season (May to September) when the weather is pleasant and rainfall is minimal. The wet season (October to April) can bring heavy rains, but it's still possible to visit. Different regions have varying weather patterns, so check specific destinations before planning your trip."
  }
];
...
const breadcrumbItems = [
  ...
  { label: "Indonesia Requirements" }
];

export default function IndonesiaRequirementsPage() {
  ...
  return (
    <>
      <RequirementsPostStructuredData country="Indonesia" countrySlug="indonesia" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="relative bg-gradient-to-r from-red-600 via-white to-red-600 text-white overflow-hidden">
          ...
          <div className="absolute inset-0">
            <Image
              src="/images/country/indonesia/indonesia-bg.jpg"
              alt="Indonesia eVisa requirements - beautiful Southeast Asian destinations and landmarks for visa travelers"
              fill
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-16">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                Indonesia eVisa Requirements & Application Guide 2024
              </h1>
              <p className="text-xl text-red-100 max-w-3xl mx-auto leading-relaxed">
                Complete guide to Indonesia eVisa requirements, application process, and travel information for your Southeast Asian adventure
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <CheckEligibilityWithPreset 
            presetDestination="id"
            title="Check Your Indonesia Visa Eligibility"
            description="Select your nationality to check if you need a visa for Indonesia"
          />
        </div>
        ...
        <section id="overview" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">About Indonesia</h3>
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-600 leading-relaxed mb-4">
                    Indonesia is the world's largest archipelago, consisting of over 17,000 islands spanning Southeast Asia. 
                    From the tropical paradise of Bali to the cultural richness of Java, from the pristine beaches of Lombok 
                    to the ancient temples of Borobudur, Indonesia offers visitors an incredible diversity of experiences.
                  </p>
                  <p className="text-slate-600 leading-relaxed mb-4">
                    The country is famous for its stunning natural landscapes, rich cultural heritage, vibrant traditions, 
                    and warm hospitality. Indonesia's unique blend of indigenous cultures, colonial influences, and modern 
                    development creates a fascinating destination for travelers from around the world.
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    Indonesia's eVisa system was introduced to streamline the visa application process, making it easier 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="text-slate-600">Indonesian (Bahasa Indonesia)</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100">
                ...
                <p className="text-slate-600">Indonesian Rupiah (IDR)</p>
              </div>
            </div>
          </div>
        </section>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    'Proof of accommodation in Indonesia (hotel bookings or invitation letter)',
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { type: 'Tourist Evisa (30 days)', fee: '$62', duration: '30 days' },
                    { type: 'Tourist Evisa (60 days)', fee: '$126', duration: '60 days' }
                  ].map((visa, index) => (
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-slate-600">2 hours</p>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                    <h4 className="font-semibold text-slate-800 mb-2">Wet Season (Oct-Apr)</h4>
                    <p className="text-sm text-slate-600">Heavy rains but still visitable</p>
                  </div>
                  <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100">
                    <h4 className="font-semibold text-slate-800 mb-2">Year-round</h4>
                    <p className="text-sm text-slate-600">Different regions have varying patterns</p>
                  </div>
                </div>
              </div>
        ...
        {/* Comprehensive Indonesia Travel Guide */}
        <section id="travel-guide" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="prose prose-slate max-w-none">
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">About Indonesia eVisa Requirements</h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Indonesia's eVisa system was introduced to streamline the visa application process for international travelers. 
                The Indonesia eVisa is an electronic travel authorization that allows visitors to enter Indonesia for tourism 
                and other purposes. This digital system has significantly improved the overall travel experience for millions 
                of visitors to Indonesia each year.
              </p>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Indonesia eVisa Eligibility & Requirements</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Most foreign nationals require an Indonesia eVisa to enter the territory, with the exception of citizens from some 
                visa-waiver countries. The eVisa system is available to travelers from eligible countries worldwide, making Indonesia 
                one of the most accessible destinations for international visitors interested in Southeast Asian culture, tropical 
                adventures, and island experiences.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-emerald-50 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-slate-600 space-y-1">
                    ...
                    <li> Temple and historical site visitors</li>
                    <li> Family visitors and relatives</li>
                  </ul>
                </div>
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who is Exempt from Indonesia eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Indonesia eVisa Application Process Explained</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                The Indonesia eVisa application process is designed to be simple and user-friendly. Our platform guides you 
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Indonesia Visa Processing Times & Fees</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Indonesia eVisa processing times typically take 2 working days for normal processing, with a super urgent 
                option available in just 2 hours. The government fees are transparent: 30-day visas cost $62, while 60-day 
                visas cost $126. We provide transparent pricing with no hidden fees.
              </p>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Popular Destinations in Indonesia</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Indonesia offers diverse attractions for every type of traveler. From the tropical paradise of Bali to the 
                cultural richness of Java, from the pristine beaches of Lombok to the ancient temples of Borobudur, Indonesia 
                provides unforgettable experiences. The country's unique blend of indigenous cultures, colonial influences, 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-slate-600">
                    From pristine beaches and tropical islands to volcanic mountains and rainforests, Indonesia offers 
                    breathtaking natural landscapes and outdoor adventures for nature lovers.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-800 mb-2">Island Adventures</h4>
                  <p className="text-sm text-slate-600">
                    From Bali's vibrant culture to Lombok's tranquility, from Java's history to Sumatra's wildlife, 
                    Indonesia's islands offer diverse experiences for every traveler.
                  </p>
                </div>
              </div>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Indonesia Travel Tips & Best Practices</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                When planning your trip to Indonesia, consider the weather patterns and seasonal attractions. The dry season 
                (May to September) offers the most pleasant weather, while the wet season (October to April) can bring heavy 
                rains. Always carry your eVisa approval letter, passport, and other required documents when traveling. 
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">30-day Tourist Evisa</span>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">60-day Tourist Evisa</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
            ...
            <div className="mt-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Best Time to Visit Indonesia</h3>
              ...
              <div className="mt-4 p-3 bg-purple-100 rounded-lg">
                <p className="text-xs text-purple-800">
                  <strong>Source:</strong> Indonesia Tourism Board & Weather Bureau
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="why-choose-us" className="mb-16">
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl border border-emerald-200 p-8 shadow-lg">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-800 mb-4 text-center">Get Your Indonesia eVisa Today</h3>
              <p className="text-slate-600 text-center mb-6">
                Join thousands of satisfied travelers who have successfully obtained their Indonesia visa through our platform. 
