...
export const metadata: Metadata = {
  title: "Kazakhstan Visa Requirements & eVisa Application | Worldmaxxing Global Services",
  ...
  openGraph: {
    ...
    url: "https://visa.worldmaxxing.com/requirements-posts/kazakhstan",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kazakhstan Visa Requirements - Worldmaxxing Global Services",
      }
    ],
    locale: "en_US",
    type: "article",
  ...
  alternates: {
    canonical: "https://visa.worldmaxxing.com/requirements-posts/kazakhstan",
  },
  robots: {
    index: true,
    follow: true,
