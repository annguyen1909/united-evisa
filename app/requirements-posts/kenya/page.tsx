...
export default function KenyaRequirementsPage() {
  ...
  return (
    <>
      <RequirementsPostStructuredData country="Kenya" countrySlug="kenya" />
        ...
        <div className="relative bg-gradient-to-r from-black via-red-600 to-green-600 text-white overflow-hidden">
          ...
          <div className="absolute inset-0">
            <Image
              ...
              alt="Kenya eVisa requirements - beautiful East African destinations and landmarks for visa travelers"
              fill
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-16">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                Kenya eVisa Requirements & Application Guide
              </h1>
              <p className="text-xl text-green-100 max-w-3xl mx-auto leading-relaxed">
                Complete guide to Kenya eVisa requirements, application process, and travel information for your East African safari adventure
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="mb-12">
            <CheckEligibilityWithPreset 
              presetDestination="ke"
              title="Check Your Kenya Visa Eligibility"
              description="Select your nationality to check if you need a visa for Kenya"
            />
          </div>
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="bg-blue-50 rounded-lg p-4">
                    <h4 className="font-semibold text-blue-800 mb-2">Who Needs a Kenya eVisa?</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-lg p-4">
                    <h4 className="font-semibold text-blue-800 mb-2">Wildlife & Safari</h4>
                ...
                <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose United eVisa Services for Kenya Visa Applications</h3>
                <p className="text-slate-600 mb-4 leading-relaxed">
                  United eVisa Services has been helping travelers obtain their Kenya visas since the eVisa system was introduced. 
                ...
                <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-xl p-6">
                  ...
                  <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                    <p className="text-xs text-blue-800">
                      <strong>Source:</strong> Kenya Immigration Department & United eVisa Services processing data
                    </p>
                  </div>
                </div>
