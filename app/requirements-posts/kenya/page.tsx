...
const faqs = [
  ...
  {
    question: "Do children need a Kenya eVisa?",
    answer: "Children under 16 years old traveling with their parents or guardians are exempt from the Kenya eVisa requirement. However, they must be included in their parents' visa application and have their own passport. Children 16 and older need their own eVisa application."
  },
  {
        ...
        <section id="why-choose-us" className="mb-16">
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl border border-emerald-200 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">
              Why Choose United eVisa for Your Kenya Visa?
            </h2>
        ...
        <section id="travel-guide" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose United eVisa for Kenya Visa Applications</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                United eVisa has been helping travelers obtain their Kenya visas since the eVisa system was introduced. 
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-emerald-100 rounded-lg">
                  <p className="text-xs text-emerald-800">
                    <strong>Source:</strong> Kenya Immigration Department & United eVisa processing data
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> United eVisa application data (2024)
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl">
                ...
                <a href="tel:+1234567890" className="text-emerald-600 font-semibold hover:text-emerald-700">
                  +1 (234) 567-890
                </a>
              </div>
              ...
              <div className="text-center p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
                ...
                <a href="mailto:support@unitedevisa.com" className="text-blue-600 font-semibold hover:text-blue-700">
            ...
            <div className="mt-8 p-6 bg-slate-50 rounded-xl">
              <h3 className="text-lg font-semibold text-slate-800 mb-3">Why Travelers Choose United eVisa</h3>
