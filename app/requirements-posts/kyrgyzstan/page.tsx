...
const kyrgyzstanVisaTypes = [
  {
    ...
    features: ['Tourism', 'Mountain trekking', 'Cultural exploration', 'Adventure travel']
  },
  {
    ...
    govFee: 92,
    processingTime: '5 working days',
    features: ['Extended tourism', 'Mountain trekking', 'Cultural exploration', 'Adventure travel']
  },
  {
...
const faqs = [
  {
    ...
    answer: 'Most foreign nationals require a visa to enter Kyrgyzstan. The eVisa system allows eligible travelers to apply online before their trip. Check your eligibility on our platform.'
  },
  {
    question: 'How long does it take to process a Kyrgyzstan eVisa?',
    answer: 'Processing time for Kyrgyzstan eVisas is typically 5 working days. Apply at least 2 weeks before your travel date to avoid delays.'
  },
  {
    question: 'What documents do I need for a Kyrgyzstan eVisa?',
  ...
  {
    question: 'Can I extend my Kyrgyzstan visa?',
    answer: 'Visa extensions are possible in Kyrgyzstan for valid reasons. Visit the local immigration office for more information about extension procedures.'
  },
  {
    question: 'Is Kyrgyzstan safe for tourists?',
    answer: 'Kyrgyzstan is generally safe for tourists. Exercise standard precautions and respect local customs and traditions, especially in remote mountain areas.'
  },
  {
    question: 'How much does a Kyrgyzstan eVisa cost?',
    answer: 'Government fees range from $56 to $92 USD depending on the visa type and duration. See the visa types section for specific details.'
  },
  {
    question: 'Can I apply for a Kyrgyzstan eVisa if I have a criminal record?',
  ...
  {
    question: 'What happens if my Kyrgyzstan eVisa application is denied?',
  ...
  {
    question: 'Can I enter Kyrgyzstan multiple times with one eVisa?',
    answer: 'No, the Kyrgyzstan eVisas are single-entry. You will need a new visa for each visit.'
  },
  {
    question: 'What should I do if I lose my Kyrgyzstan eVisa approval letter?',
...
const breadcrumbItems = [
  ...
  { label: "Kyrgyzstan Requirements" }
];

export default function KyrgyzstanRequirementsPage() {
  ...
  return (
    <>
      <RequirementsPostStructuredData country="Kyrgyzstan" countrySlug="kyrgyzstan" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        {/* Hero Section */}
        <div className="relative bg-gradient-to-r from-red-600 via-yellow-400 to-red-600 text-white overflow-hidden">
          <div className="absolute inset-0 bg-black/20"></div>
          <div className="absolute inset-0">
            <Image
              src="/images/country/kyrgyzstan/kyrgyzstan-bg.jpg"
              alt="Kyrgyzstan eVisa requirements - beautiful Central Asian destinations and landmarks for visa travelers"
              fill
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <CheckEligibilityWithPreset 
            presetDestination="kg"
            title="Check Your Kyrgyzstan Visa Eligibility"
            description="Select your nationality to check if you need a visa for Kyrgyzstan"
          />
        </div>
        ...
        <section id="overview" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">About Kyrgyzstan</h3>
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-600 leading-relaxed mb-4">
                    Kyrgyzstan, a landlocked country in Central Asia, is renowned for its stunning mountain landscapes and nomadic culture. From the majestic Tien Shan mountains to the pristine Lake Issyk-Kul, Kyrgyzstan offers unparalleled natural beauty and adventure opportunities.
                  </p>
                  <p className="text-slate-600 leading-relaxed mb-4">
                    The country is home to traditional yurt camps, ancient Silk Road sites, and some of the most spectacular hiking trails in the world. Whether you're interested in mountain trekking, experiencing nomadic culture, or exploring historical sites, Kyrgyzstan provides unforgettable experiences for adventure travelers.
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    The Kyrgyzstan eVisa system makes it easy for international visitors to obtain travel authorization online before arrival, streamlining the process for tourism and adventure travel.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2">
                  <span className="text-sm font-semibold text-slate-800">🇰🇬 Kyrgyzstan</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-r from-blue-50 to-amber-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="text-slate-600">Bishkek</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="text-slate-600">Kyrgyz, Russian</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100">
                ...
                <p className="text-slate-600">Kyrgyzstani Som (KGS)</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="visa-types" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {kyrgyzstanVisaTypes.map((visa, index) => (
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <h4 className="font-semibold text-blue-800 mb-2">Transit Visa</h4>
                    <ul className="text-sm text-slate-600 space-y-1">
                      <li>• Proof of onward travel within 5 days</li>
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    ...
                    <ul className="text-sm text-slate-600 space-y-1">
                      <li>• Kyrgyzstan has a continental climate</li>
                      <li>• Russian is widely spoken in urban areas</li>
                      <li>• Check current travel advisories for mountain regions</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-amber-50 rounded-lg border border-blue-100">
                    ...
                    <p className="text-sm text-slate-600">Peak season for mountain trekking and outdoor activities with pleasant weather</p>
                  </div>
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                    <h4 className="font-semibold text-slate-800 mb-2">March to May</h4>
                    <p className="text-sm text-slate-600">Spring season with blooming landscapes, suitable for cultural tours</p>
                  </div>
                  <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100">
                    <h4 className="font-semibold text-slate-800 mb-2">October to February</h4>
                    <p className="text-sm text-slate-600">Cold winter months, suitable for winter sports and indoor activities</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    'Land borders with Kazakhstan, Uzbekistan, Tajikistan, and China',
        ...
        <section id="why-choose-us" className="mb-16">
          <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-2xl border border-blue-200 p-8 shadow-lg">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-800 mb-4 text-center">Get Your Kyrgyzstan eVisa Today</h3>
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who Needs a Kyrgyzstan eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose United eVisa Services for Kyrgyzstan Visa Applications</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                United eVisa Services has been helping travelers obtain their Kyrgyzstan visas since the eVisa system 
        ...
        <section id="analytics" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              ...
              Kyrgyzstan Visa Processing Insights & Travel Analytics
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> Kyrgyzstan Ministry of Foreign Affairs & United eVisa Services processing data
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Tourist 60 Days</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Transit 5 Days</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
            ...
            <div className="mt-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Best Time to Visit Kyrgyzstan</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <h4 className="font-semibold text-slate-800 text-sm">Oct-Feb</h4>
                ...
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-xs text-slate-600">Adventure</p>
                  <div className="mt-2">
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
              ...
              <div className="mt-4 p-3 bg-purple-100 rounded-lg">
                <p className="text-xs text-purple-800">
                  <strong>Source:</strong> Kyrgyzstan Tourism Board & Meteorological Department
                </p>
              </div>
            </div>
          </div>
