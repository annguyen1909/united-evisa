...
export const metadata: Metadata = {
  title: "Pakistan Visa Requirements & eVisa Application | Worldmaxxing Global Services",
  ...
  openGraph: {
    ...
    url: "https://visa.worldmaxxing.com/requirements-posts/pakistan",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Pakistan Visa Requirements - Worldmaxxing Global Services",
      }
    ],
    locale: "en_US",
    type: "article",
  ...
  alternates: {
    canonical: "https://visa.worldmaxxing.com/requirements-posts/pakistan",
  },
  robots: {
    index: true,
    follow: true,
