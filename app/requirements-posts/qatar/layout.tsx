...
export const metadata: Metadata = {
  title: "Qatar Visa Requirements & eVisa Application | Worldmaxxing Global Services",
  ...
  openGraph: {
    ...
    url: "https://visa.worldmaxxing.com/requirements-posts/qatar",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Qatar Visa Requirements - Worldmaxxing Global Services",
      }
    ],
    locale: "en_US",
    type: "article",
  ...
  alternates: {
    canonical: "https://visa.worldmaxxing.com/requirements-posts/qatar",
  },
  robots: {
    index: true,
    follow: true,
