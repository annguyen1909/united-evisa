        ...
        <section id="why-choose-us" className="mb-16">
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl border border-emerald-200 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">
              Why Choose Worldmaxxing Global Services for Your Saudi Arabia Visa?
            </h2>
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-emerald-100 rounded-lg">
                  <p className="text-xs text-emerald-800">
                    <strong>Source:</strong> Saudi Arabia Ministry of Foreign Affairs & Worldmaxxing Global Services processing data
                  </p>
                </div>
              </div>
            </div>
