...
const faqs = [
  {
    ...
    answer: "Most foreign nationals require a visa to enter Tanzania. The Tanzania eVisa system allows travelers from eligible countries to apply online before their trip. The eVisa is mandatory for tourism, business, and transit purposes. Citizens of some East African Community countries may be exempt from visa requirements."
  },
  {
    question: "How long does it take to process a Tanzania eVisa?",
    answer: "Processing time for Tanzania eVisas typically takes 15 working days. We recommend applying at least 3 weeks before your intended travel date to avoid any delays. Our platform has a 95% approval rate, and we provide 24/7 support throughout the application process."
  },
  {
    question: "What documents do I need for a Tanzania eVisa?",
    answer: "You'll need a valid passport with at least 6 months validity beyond your intended stay, a recent passport-size photo, proof of accommodation in Tanzania, return flight tickets, and sufficient funds for your stay. Business travelers may need additional documents like invitation letters. All documents should be clear, legible, and in English."
  },
  {
    question: "Can I extend my Tanzania visa?",
    answer: "Yes, you can extend your Tanzania visa while in the country. You'll need to visit the Immigration Department in Dar es Salaam or other major cities. Extensions are typically granted for valid reasons such as medical treatment, business needs, or tourism. There are fees associated with visa extensions, and the process can take several days."
  },
  {
    question: "Is it safe to travel to Tanzania?",
    answer: "Tanzania is generally safe for tourists, especially in popular tourist areas like Dar es Salaam, Arusha, and Zanzibar. However, it's important to stay informed about current travel advisories, avoid certain areas near the border with Mozambique, and take standard safety precautions like not walking alone at night. Most tourist destinations have good security measures in place."
  },
  {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-emerald-100 max-w-3xl mx-auto leading-relaxed">
              Complete guide to Tanzania eVisa requirements, application process, and travel information for your African adventure
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                <div>
                  ...
                  <div className="prose prose-slate max-w-none">
                    ...
                    Tanzania, located in East Africa, is renowned for its diverse wildlife, stunning landscapes, and rich cultural heritage. 
                    From the iconic Serengeti National Park to the pristine beaches of Zanzibar, Tanzania offers unforgettable experiences 
                    for every type of traveler.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-4">
                    The country is home to Mount Kilimanjaro, Africa's highest peak, and features diverse ecosystems including savannas, 
                    forests, and coastal areas. Dar es Salaam, the largest city, serves as the main gateway for international travelers.
                    </p>
                    <p className="text-slate-600 leading-relaxed">
                    Tanzania's visa system has been modernized with the introduction of the eVisa program, making it easier for international 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    'Proof of accommodation in Tanzania (hotel bookings or invitation letter)',
                ...
                <div className="space-y-4">
                  {[
                    'Invitation letter from Tanzanian business partner or organization',
            ...
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                  {[
                    { type: 'Tourist Evisa', fee: '$95', duration: '90 days' },
                    { type: 'Business Evisa', fee: '$295', duration: '90 days' },
                    { type: 'Transit Evisa', fee: '$75', duration: '7 days' }
                  ].map((visa, index) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg border border-emerald-100">
                    ...
                    <p className="text-sm text-slate-600">Witness the Great Migration in Serengeti</p>
                  </div>
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                    <h4 className="font-semibold text-slate-800 mb-2">Beach Holidays (Year-round)</h4>
                    <p className="text-sm text-slate-600">Zanzibar offers pleasant weather throughout the year</p>
                  </div>
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">Entry Points</h3>
                  <div className="space-y-3">
                    ...
                    'Mwanza Airport',
                    'Land borders with Kenya, Uganda, and Zambia'
                  ].map((entry, index) => (
        ...
        {/* Comprehensive Tanzania Travel Guide */}
        <section id="travel-guide" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              <Globe className="h-8 w-8 text-emerald-600" />
              Complete Tanzania Travel Guide & Visa Information
            </h2>
            
            <div className="prose prose-slate max-w-none">
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">About Tanzania eVisa Requirements</h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Tanzania introduced its eVisa system to streamline the visa application process for international travelers. 
                The Tanzania eVisa is an electronic travel authorization that allows visitors to enter Tanzania for tourism, business, 
                or transit purposes. This digital system has significantly improved the overall travel experience for millions of 
                visitors to Tanzania each year.
              </p>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Tanzania eVisa Eligibility & Requirements</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Most foreign nationals require a Tanzania eVisa to enter the country, with the exception of citizens from East 
                African Community (EAC) countries. The eVisa system is available to travelers from over 150 countries worldwide, 
                making Tanzania one of the most accessible African destinations for international visitors.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-emerald-50 rounded-lg p-4">
                  <h4 className="font-semibold text-emerald-800 mb-2">Who Needs a Tanzania eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li> International tourists visiting Tanzania for leisure</li>
                    <li> Business travelers attending meetings or conferences</li>
                    <li> Transit passengers with layovers in Tanzania</li>
                    <li> Journalists and media professionals</li>
                    <li> Students attending educational programs</li>
                  </ul>
                        </div>
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who is Exempt from Tanzania eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Tanzania eVisa Application Process Explained</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                The Tanzania eVisa application process is designed to be simple and user-friendly. Our platform guides you 
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Tanzania Visa Processing Times & Fees</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Tanzania eVisa processing times typically take 15 working days, making it one of the most reliable visa 
                processing systems in Africa. The government fees are transparent and vary by visa type: Tourist ETAs cost 
                $95 for 90-day stays, Business ETAs cost $295 for 90-day stays, while Transit ETAs cost $75 for 7-day stays. 
                Unlike many other visa services, we do not charge additional urgent processing fees, ensuring you get the best 
                value for your money.
              </p>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Popular Destinations in Tanzania</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Tanzania offers diverse attractions for every type of traveler. From the world-famous Serengeti National 
                Park, where you can witness the Great Migration, to the pristine beaches of Zanzibar and the majestic 
                Mount Kilimanjaro, Tanzania provides unforgettable experiences. Dar es Salaam, the largest city, offers 
                modern amenities and cultural attractions, while traditional villages showcase authentic Tanzanian culture.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-slate-600">
                    Serengeti, Ngorongoro, Tarangire, and Lake Manyara National Parks offer world-class safari experiences 
                    with the Big Five and annual wildebeest migration.
                  </p>
                        </div>
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Beach & Coastal</h4>
                  <p className="text-sm text-slate-600">
                    Zanzibar features pristine beaches, coral reefs, and rich Swahili culture along the Indian Ocean coast.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-800 mb-2">Adventure & Culture</h4>
                  <p className="text-sm text-slate-600">
                    Mount Kilimanjaro offers climbing opportunities, while traditional villages showcase authentic 
                    Tanzanian culture and heritage.
                  </p>
                </div>
              </div>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Tanzania Travel Tips & Best Practices</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                When planning your trip to Tanzania, consider the weather patterns and seasonal attractions. The dry seasons 
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose Worldmaxxing Global Services for Tanzania Visa Applications</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Worldmaxxing Global Services has been helping travelers obtain their Tanzania visas since the eVisa system was introduced. 
                Our expertise in the Tanzanian visa process, combined with our 95% approval rate and 24/7 customer support, 
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-emerald-600">14.2 days</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-emerald-600">15.1 days</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-emerald-600">13.8 days</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-emerald-600">14.5 days</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-emerald-600">14.0 days</span>
                    </div>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-emerald-100 rounded-lg">
                  <p className="text-xs text-emerald-800">
                    <strong>Source:</strong> Tanzania Immigration Department & Worldmaxxing Global Services processing data
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> <a href="https://tanzania-immigration.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-900">tanzania-immigration.com</a> (2024)
                  </p>
                </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
                  ...
                  <div className="mt-4 p-3 bg-purple-100 rounded-lg">
                    <p className="text-xs text-purple-800">
                      <strong>Source:</strong> Tanzania Meteorological Department & Tourism Board
                    </p>
                  </div>
                    </div>
                    </div>
        ...
        <section id="why-choose-us" className="mb-16">
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl border border-emerald-200 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">
              Why Choose Worldmaxxing Global Services for Your Tanzania Visa?
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="text-center p-6 bg-white rounded-xl shadow-md">
                ...
                <p className="text-sm text-slate-600">Bank-level security with 15-day processing for most applications.</p>
              </div>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-800 mb-4 text-center">Get Your Tanzania eVisa Today</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/apply?country=tanzania">
            ...
            <div className="mt-8 p-6 bg-slate-50 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-600">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-600" />
                    <span>Fast processing with 15-day turnaround</span>
                  </li>
                </ul>
              </div>
            </div>
