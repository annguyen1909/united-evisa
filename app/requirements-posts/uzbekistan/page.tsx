...
const uzbekistanVisaTypes = [
  {
    ...
    features: ['Tourism', 'Cultural exploration', 'Historical sites', 'Silk Road cities']
  },
  {
...
const faqs = [
  {
    ...
    answer: 'Most foreign nationals require a visa to enter Uzbekistan. The eVisa system allows eligible travelers to apply online before their trip. Check your eligibility on our platform.'
  },
  {
    question: 'How long does it take to process an Uzbekistan eVisa?',
    answer: 'Processing time for Uzbekistan eVisas is typically 5 working days. Apply at least 2 weeks before your travel date to avoid delays.'
  },
  {
    question: 'What documents do I need for an Uzbekistan eVisa?',
  ...
  {
    question: 'Can I extend my Uzbekistan visa?',
    answer: 'Visa extensions are possible in Uzbekistan for valid reasons. Visit the local immigration office for more information about extension procedures.'
  },
  {
    question: 'Is Uzbekistan safe for tourists?',
    answer: 'Uzbekistan is generally safe for tourists. Exercise standard precautions and respect local customs and traditions.'
  },
  {
    question: 'How much does an Uzbekistan eVisa cost?',
    answer: 'Government fees range from $50 to $80 USD depending on the visa type and number of entries. See the visa types section for specific details.'
  },
  {
    question: 'Can I apply for an Uzbekistan eVisa if I have a criminal record?',
  ...
  {
    question: 'What happens if my Uzbekistan eVisa application is denied?',
  ...
  {
    question: 'Can I enter Uzbekistan multiple times with one eVisa?',
    answer: 'It depends on your visa type. Single entry visas allow one entry, double entry visas allow two entries, and multiple entry visas allow unlimited entries during validity.'
  },
  {
    question: 'What should I do if I lose my Uzbekistan eVisa approval letter?',
...
const breadcrumbItems = [
  ...
  { label: "Uzbekistan Requirements" }
];

export default function UzbekistanRequirementsPage() {
  ...
  return (
    <>
      <RequirementsPostStructuredData country="Uzbekistan" countrySlug="uzbekistan" />
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              Uzbekistan Visa <span className="text-blue-200">Requirements</span>
            </h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Complete guide to Uzbekistan eVisa requirements, application process, and travel information for your Silk Road adventure
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <CheckEligibilityWithPreset 
            presetDestination="uz"
            title="Check Your Uzbekistan Visa Eligibility"
            description="Select your nationality to check if you need a visa for Uzbekistan"
          />
        </div>
        ...
        <section id="overview" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-slate-800 mb-4">About Uzbekistan</h3>
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-600 leading-relaxed mb-4">
                    Uzbekistan, a landlocked country in Central Asia, is home to some of the most magnificent Silk Road cities in the world. From the stunning blue-tiled architecture of Samarkand to the ancient streets of Bukhara, Uzbekistan offers a journey through time and culture.
                  </p>
                  <p className="text-slate-600 leading-relaxed mb-4">
                    The country is renowned for its rich history, beautiful Islamic architecture, and warm hospitality. Whether you're exploring the Registan Square, wandering through ancient bazaars, or experiencing traditional Uzbek cuisine, every moment in Uzbekistan is filled with wonder and discovery.
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    The Uzbekistan eVisa system makes it easy for international visitors to obtain travel authorization online before arrival, streamlining the process for tourism and business travel.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2">
                  <span className="text-sm font-semibold text-slate-800">🇺🇿 Uzbekistan</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-r from-blue-50 to-amber-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="text-slate-600">Tashkent</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="text-slate-600">Uzbek</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100">
                ...
                <p className="text-slate-600">Uzbekistani Som (UZS)</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="visa-types" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {uzbekistanVisaTypes.map((visa, index) => (
                <Card key={index} className="overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 bg-white/90 backdrop-blur-sm">
                  ...
                  <CardFooter className="pt-4 pb-6">
                    <Link href={`/apply?country=uzbekistan&type=${encodeURIComponent(visa.id)}`} className="w-full">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    ...
                    <ul className="text-sm text-slate-600 space-y-1">
                      <li>• Invitation letter from Uzbek business partner</li>
                  ...
                  <div className="p-4 bg-green-50 rounded-lg">
                    ...
                    <ul className="text-sm text-slate-600 space-y-1">
                      <li>• Uzbekistan has a continental climate</li>
                      <li>• English is limited, learn basic Uzbek phrases</li>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-amber-50 rounded-lg border border-blue-100">
                    ...
                    <p className="text-sm text-slate-600">Pleasant weather with moderate temperatures, ideal for sightseeing and outdoor activities</p>
                  </div>
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                    <h4 className="font-semibold text-slate-800 mb-2">June to August</h4>
                    <p className="text-sm text-slate-600">Hot summer months, suitable for early morning and evening activities</p>
                  </div>
                  <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100">
                    <h4 className="font-semibold text-slate-800 mb-2">December to February</h4>
                    <p className="text-sm text-slate-600">Cold winter months, suitable for indoor activities and cultural experiences</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    'Land borders with Kazakhstan, Kyrgyzstan, Tajikistan, Afghanistan, and Turkmenistan',
        ...
        <section id="why-choose-us" className="mb-16">
          <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-2xl border border-blue-200 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">
              Why Choose United eVisa Services for Your Uzbekistan Visa?
            </h2>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-800 mb-4 text-center">Get Your Uzbekistan eVisa Today</h3>
              <p className="text-slate-600 text-center mb-6">
                Join thousands of satisfied travelers who have successfully obtained their Uzbekistan visa through our platform. 
                Our streamlined process ensures you get your visa quickly and hassle-free.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/apply?country=uzbekistan">
        ...
        {/* Comprehensive Uzbekistan Travel Guide */}
        <section id="travel-guide" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              <Globe className="h-8 w-8 text-blue-600" />
              Complete Uzbekistan Travel Guide & Visa Information
            </h2>
            
            <div className="prose prose-slate max-w-none">
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">About Uzbekistan eVisa Requirements</h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Uzbekistan's eVisa system was introduced to streamline the visa application process for international travelers. 
                The Uzbekistan eVisa is an electronic travel authorization that allows visitors to enter Uzbekistan for tourism, 
                business, and other purposes. This digital system has significantly improved the overall travel experience for 
                millions of visitors to Uzbekistan each year.
              </p>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Uzbekistan eVisa Eligibility & Requirements</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Most foreign nationals require an Uzbekistan eVisa to enter the territory, with the exception of citizens from some 
                visa-waiver countries. The eVisa system is available to travelers from eligible countries worldwide, making Uzbekistan 
                one of the most accessible destinations for international visitors interested in Silk Road history, Islamic architecture, 
                and Central Asian culture.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who Needs an Uzbekistan eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li> International tourists visiting Uzbekistan for leisure</li>
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Who is Exempt from Uzbekistan eVisa?</h4>
                  <ul className="text-sm text-slate-600 space-y-1">
                    <li> Uzbek citizens and permanent residents</li>
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Uzbekistan eVisa Application Process Explained</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                The Uzbekistan eVisa application process is designed to be simple and user-friendly. Our platform guides you 
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Uzbekistan Visa Processing Times & Fees</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Uzbekistan eVisa processing times typically take 4 working days for normal processing. The government fees 
                are transparent: Tourist eVisa costs $25, while Business eVisa costs $35. We provide transparent pricing 
                with no hidden fees.
              </p>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Popular Destinations in Uzbekistan</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                Uzbekistan offers diverse attractions for every type of traveler. From the historic cities of the Silk Road 
                to the stunning Islamic architecture, from the ancient bazaars to the beautiful mosques, Uzbekistan provides 
                unforgettable experiences. The country's unique blend of Central Asian culture, Islamic heritage, 
                and Silk Road history creates a fascinating destination for travelers.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Silk Road Heritage</h4>
                  <p className="text-sm text-slate-600">
                    From the ancient cities of Samarkand, Bukhara, and Khiva to the historic trading routes, 
                    Uzbekistan offers world-class cultural experiences and insights into Silk Road history.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Islamic Architecture</h4>
                  <p className="text-sm text-slate-600">
                    From the Registan complex to the Bibi-Khanym Mosque, from madrasas to mausoleums, Uzbekistan offers 
                    stunning architectural masterpieces and religious heritage sites.
                  </p>
                </div>
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4">
                  <h4 className="font-semibold text-purple-800 mb-2">Cultural Experiences</h4>
                  <p className="text-sm text-slate-600">
                    From traditional bazaars to craft workshops, from cultural centers to historical museums, Uzbekistan offers 
                    rich cultural experiences and insights into Central Asian traditions.
                  </p>
                </div>
              </div>
              
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Uzbekistan Travel Tips & Best Practices</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                When planning your trip to Uzbekistan, consider the continental climate and cultural customs. The best 
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">Why Choose United eVisa Services for Uzbekistan Visa Applications</h3>
              <p className="text-slate-600 mb-4 leading-relaxed">
                United eVisa Services has been helping travelers obtain their Uzbekistan visas since the eVisa system 
                was introduced. Our expertise in the Uzbekistan visa process, combined with our 98% approval rate and 24/7 
        ...
        <section id="analytics" className="mb-16">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/50 p-8 shadow-lg">
            <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center gap-3">
              ...
              Uzbekistan Visa Processing Insights & Travel Analytics
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-amber-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> Uzbekistan Ministry of Foreign Affairs & United eVisa Services processing data
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Tourist Single Entry</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Tourist Double Entry</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Tourist Multiple Entry</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-slate-600">Business Visas</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-3 bg-blue-200 rounded-full overflow-hidden">
                        <div className="h-full bg-blue-500 rounded-full" style={{width: '20%'}}></div>
                      </div>
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> <a href="https://e-visa.gov.uz/" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-900">e-visa.gov.uz</a> (2024)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-slate-800 mb-4">Best Time to Visit Uzbekistan</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-xs text-slate-600">Spring Peak</p>
                  <div className="mt-2">
                ...
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-xs text-slate-600">Autumn Peak</p>
                  <div className="mt-2">
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                ...
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-xs text-slate-600">Hot Summer</p>
                  <div className="mt-2">
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                ...
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  ...
                  <p className="text-xs text-slate-600">Cold Winter</p>
                  <div className="mt-2">
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
              ...
              <div className="mt-4 p-3 bg-purple-100 rounded-lg">
                <p className="text-xs text-purple-800">
                  <strong>Source:</strong> Uzbekistan Tourism Board & Meteorological Department
                </p>
              </div>
            </div>
          </div>
