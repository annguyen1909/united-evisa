              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                  <p className="text-xs text-blue-800">
                    <strong>Source:</strong> <a href="https://www.zambiaimmigration.gov.zm/" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-900">zambiaimmigration.gov.zm</a> (2024)
                  </p>
                </div>
              </div>
            </div>
