...
import { indiaVisaFeeTable, calculateIndiaVisaFee } from '@/lib/countries/india'; // Import the fee table
...
const visaSteps = [
    ...
    },
    {
        name: "3",
        title: "Get Your eTA",
        description: "eTA will be delivered to your email",
                                            ...
                                            <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        ...
                                                        <p className="font-medium text-slate-800">{visa.visaDuration ? visa.visaDuration + ' days' : 'Not specified'}</p>
                                                    </div>
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        ...
                                                        <div className="flex items-center">
                                                            <p className="font-medium text-slate-800">US$ 59.99</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
