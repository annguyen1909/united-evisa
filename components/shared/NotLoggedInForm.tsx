    ...
    <div className="max-w-xl mx-auto mt-10">
      <Card className="p-8">
        ...
        <div className="mb-4 text-center">
          ...
          <br />
                          You can also email your documents directly to <a href="mailto:visa@worldmaxxing.com" className="text-blue-600 underline">visa@worldmaxxing.com</a> with the subject line: <b>Documents for Application {applicationId}</b>
        </div>
        <div className="flex justify-center gap-4 mt-6">
          <Link href={`/login${email ? `?email=${encodeURIComponent(email)}` : ""}`}>
            <Button>Login Now</Button>
          </Link>
                          <a href={`mailto:visa@worldmaxxing.com?subject=Documents for Application ${applicationId}`}>
