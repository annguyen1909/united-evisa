...
const kuwait: Country = {
  ...
  region: 'Middle East',
  code: 'kw',
  flagUrl: '/images/flags/square/kuwait.png',
  imageUrl: '/images/country/kuwait/kuwait-bg.jpg',
  roundedFlagUrl: '/images/flags/square/kuwait.png',
  description: `Apply for your Kuwait eVisa online with United eVisa Services. Fast, secure, and convenient visa application for Kuwait travel. Get your Kuwait visa quickly with our expert assistance.`,
