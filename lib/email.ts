...
export async function sendEmail({ to, template, data }: SendEmailProps) {
  ...
  try {
    const from = 'United eVisa Support <visa@unitedevisa.com>';
    let subject = '';
    let html = '';
    let recipient = to;
    let emailSubject = '';
    ...
    switch (template) {
      case 'payment-confirmation': {
        ...
        subject = `Payment Confirmation for Your United eVisa (ID: ${application.applicationId})`;
        html = `
          <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            ...
            <div style="padding: 20px;">
              ...
              <p>Thank you for your payment. Your application for the United eVisa has been successfully submitted and is now being processed.</p>
            ...
            <div style="background-color: #f0f0f0; padding: 15px; font-size: 12px; text-align: center; color: #666;">
              ...
              <p>&copy; ${new Date().getFullYear()} United eVisa. All Rights Reserved.</p>
            </div>
          </div>
        `;
        break;
      ...
      case 'welcome': {
        ...
        subject = 'Welcome to United eVisa';
        html = `
          <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            <div style="background-color: #059669; color: white; padding: 20px; text-align: center;">
              <h1 style="margin: 0; font-size: 24px;">Welcome to United eVisa!</h1>
            </div>
            <div style="padding: 20px;">
              <p>Dear ${user?.fullName || 'Customer'},</p>
              <p>Thank you for creating an account with United eVisa. We're excited to help you with your visa application process.</p>
              ...
              <p>Best regards,<br>United eVisa Team</p>
            </div>
            <div style="background-color: #f0f0f0; padding: 15px; font-size: 12px; text-align: center; color: #666;">
              <p>&copy; ${new Date().getFullYear()} United eVisa. All Rights Reserved.</p>
            </div>
      ...
      case 'verify-email': {
        ...
        const user = await prisma.account.findFirst({ where: { email: recipient } });
        subject = 'Verify Your Email - United eVisa';
        html = `
          <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            <div style="background-color: #059669; color: white; padding: 20px; text-align: center;">
      ...
      case 'reset-password': {
        ...
        const user = await prisma.account.findFirst({ where: { email: recipient } });
        subject = 'Reset Your Password - United eVisa';
        html = `
          <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            <div style="background-color: #059669; color: white; padding: 20px; text-align: center;">
      ...
      case 'contact-confirmation': {
        ...
        subject = 'Thank you for contacting United eVisa';
        html = `
          <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            <div style="background-color: #059669; color: white; padding: 20px; text-align: center;">
            ...
            <div style="padding: 20px;">
              ...
              <p>Thank you for contacting United eVisa. We have received your message and our support team will get back to you as soon as possible.</p>
              ...
              <p>Best regards,<br>United eVisa Support Team</p>
            </div>
            <div style="background-color: #f0f0f0; padding: 15px; font-size: 12px; text-align: center; color: #666;">
              <p>&copy; ${new Date().getFullYear()} United eVisa. All Rights Reserved.</p>
            </div>
      ...
      default: {
        ...
        subject = 'United eVisa Notification';
        html = `<p>This is a default notification from United eVisa.</p>`;
        break;
      }
    }
